...
@media print {
    ...
    <body>
        ...
        <div class="resume-container">
            ...
            <div class="content">
                <div class="section">
                    <div class="status-badge">🎯 Actively Seeking Data Science Opportunities</div>
                </div>
                
                <div class="section">
                    <h2 class="section-title">Professional Summary</h2>
                    <div class="summary">
                        Recent PhD graduate in Physics with a proven track record of 8+ published research papers and 7+ years of experience in computational modeling, statistical analysis, and machine learning. Expertise in Python, R, SQL, and advanced analytics with a strong background in solving complex problems using data-driven approaches. Available immediately for full-time positions and open to relocation.
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="experience-item">
                        ...
                        <div class="company-info">Georgia Institute of Technology, Atlanta, GA | Aug 2019 - Present</div>
                        <ul class="achievements">
...
export default function KrishnaResume() {
  ...
  return (
    <div className={`min-h-screen transition-all duration-300 ${darkMode ? 'dark bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg shadow-sm z-40 border-b border-gray-200 dark:border-gray-700">
        <ul className="flex justify-center space-x-8 py-4 text-sm font-medium">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div>
                        ...
                        <a href="https://linkedin.com/in/krishna-aryal" target="_blank" className="text-blue-600 dark:text-blue-400 hover:underline">
